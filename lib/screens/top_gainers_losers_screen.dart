...
class _TopGainersLosersScreenState extends State<TopGainersLosersScreen>
  ...
  String get _gainersType => _mode == 'OI %' ? 'PercOIGainers'    : 'PercPriceGainers';
  String get _losersType  => _mode == 'OI %' ? 'PercOILosers'     : 'PercPriceLosers';

  Future<void> _fetch() async {
    setState(() { _loading = true; _error = null; });
    try {
      final results = await Future.wait([
        _api.getDerivativeGainersLosers(datatype: _gainersType, expiry: _expiry),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          _DropdownChip(
            ...
            onChanged: (v) { setState(() => _expiry = v); _fetch(); },
          ),
          const SizedBox(width: 4),
          IconButton(
      ...
      body: Column(
        children: [
          if (_loading)
            const Expanded(
              child: BackendLoadingWidget(message: 'Loading derivatives data...'),
            )
          else if (_error != null)
            Expanded(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            underlying.isNotEmpty ? underlying : item.tradingSymbol,
