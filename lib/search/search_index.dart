...
final kInstrumentCatalog = <Instrument>[
  ...
  // BSE mirrors
  Instrument(symbol: 'RELIANCE',   displayName: 'RELIANCE',   name: 'Reliance Industries Ltd',       exchange: 'BSE', segment: InstrumentSegment.eq, aliases: ['ril'], popularityRank: 11),
  Instrument(symbol: 'TCS',        displayName: 'TCS',        name: 'Tata Consultancy Services',     exchange: 'BSE', segment: InstrumentSegment.eq, aliases: [], popularityRank: 12),
  Instrument(symbol: 'INFY',       displayName: 'INFY',       name: 'Infosys Ltd',                   exchange: 'BSE', segment: InstrumentSegment.eq, aliases: [], popularityRank: 13),
  Instrument(symbol: 'HDFCBANK',   displayName: 'HDFCBANK',   name: 'HDFC Bank Ltd',                 exchange: 'BSE', segment: InstrumentSegment.eq, aliases: [], popularityRank: 14),
  ...
  Instrument(symbol: 'TCS FUT',        displayName: 'TCS FUT',        name: 'TCS Futures (Near)',         exchange: 'NFO', segment: InstrumentSegment.fut, aliases: [], popularityRank: 4),
  Instrument(symbol: 'INFY FUT',       displayName: 'INFY FUT',       name: 'Infosys Futures (Near)',     exchange: 'NFO', segment: InstrumentSegment.fut, aliases: ['infosys fut'], popularityRank: 5),
  // ── MCX Commodities ──────────────────────────────────────────────────────────
  Instrument(symbol: 'GOLD',       displayName: 'GOLD',       name: 'Gold 1kg MCX Futures',          exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['gold mcx', 'sona'], popularityRank: 1),
  Instrument(symbol: 'SILVER',     displayName: 'SILVER',     name: 'Silver 30kg MCX Futures',       exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['silver mcx', 'chandi'], popularityRank: 2),
  Instrument(symbol: 'CRUDEOIL',   displayName: 'CRUDEOIL',   name: 'Crude Oil 100bbl MCX Futures',  exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['crude', 'crude oil', 'wti'], popularityRank: 3),
  ...
  Instrument(symbol: 'COPPER',     displayName: 'COPPER',     name: 'Copper 1MT MCX Futures',        exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['copper mcx', 'tambe'], popularityRank: 5),
  Instrument(symbol: 'ZINC',       displayName: 'ZINC',       name: 'Zinc 5MT MCX Futures',          exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['zinc mcx'], popularityRank: 6),
  Instrument(symbol: 'LEAD',       displayName: 'LEAD',       name: 'Lead 5MT MCX Futures',          exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['lead mcx'], popularityRank: 7),
  Instrument(symbol: 'ALUMINIUM',  displayName: 'ALUMINIUM',  name: 'Aluminium 5MT MCX Futures',     exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['alum', 'aluminium mcx'], popularityRank: 8),
  Instrument(symbol: 'NICKEL',     displayName: 'NICKEL',     name: 'Nickel 250kg MCX Futures',      exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['nickel mcx'], popularityRank: 9),
  Instrument(symbol: 'COTTON',     displayName: 'COTTON',     name: 'Cotton 25 bales MCX Futures',   exchange: 'MCX', segment: InstrumentSegment.comm, aliases: ['cotton mcx', 'kapas'], popularityRank: 10),
  // ── Currency ──────────────────────────────────────────────────────────────────
  Instrument(symbol: 'USDINR',     displayName: 'USDINR',     name: 'US Dollar / Indian Rupee',      exchange: 'CDS', segment: InstrumentSegment.curr, aliases: ['usd inr', 'dollar rupee', 'inr usd'], popularityRank: 1),
  ...
  Instrument(symbol: 'GBPINR',     displayName: 'GBPINR',     name: 'British Pound / Indian Rupee',  exchange: 'CDS', segment: InstrumentSegment.curr, aliases: ['gbp inr', 'pound rupee'], popularityRank: 3),
  Instrument(symbol: 'JPYINR',     displayName: 'JPYINR',     name: 'Japanese Yen / Indian Rupee',   exchange: 'CDS', segment: InstrumentSegment.curr, aliases: ['jpy inr', 'yen rupee'], popularityRank: 4),
  // ── ETFs ──────────────────────────────────────────────────────────────────────
  ...
  Instrument(symbol: 'ICICIB22',   displayName: 'ICICIB22',   name: 'ICICI Prudential Bharat 22 ETF',exchange: 'NSE', segment: InstrumentSegment.etf, aliases: ['bharat 22', 'b22'], popularityRank: 4),
  // ── Sovereign Gold Bonds ──────────────────────────────────────────────────────
  Instrument(symbol: 'SGBFEB28',   displayName: 'SGB FEB 28', name: 'Sovereign Gold Bond Feb 2028',  exchange: 'NSE', segment: InstrumentSegment.bond, aliases: ['sgb', 'sovereign gold bond', 'gold bond'], popularityRank: 1),
];
...
class SearchIndex {
  ...
  int _score(Instrument inst, String q) {
    ...
    const commodityHints = ['crude', 'gold', 'silver', 'copper', 'zinc', 'nickel', 'nat gas', 'naturalgas', 'aluminium', 'lead', 'cotton'];
    ...
    if ((q.contains('fut') || q.contains('future')) && inst.segment == InstrumentSegment.fut) {
      score += 80;
    }
